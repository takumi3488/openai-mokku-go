...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	default:
		...
		case '/': // Prefix: "/"
			...
			case 'e': // Prefix: "embeddings"

				if l := len("embeddings"); len(elem) >= l && elem[0:l] == "embeddings" {
					elem = elem[l:]
				} else {
					break
				}
			...
			case 'r': // Prefix: "responses"
				...
				if len(elem) == 0 {
					...
					switch r.Method {
					case "POST":
						s.handleCreateResponseRequest([0]string{}, elemIsEscaped, w, r)
					default:
						s.notAllowed(w, r, notAllowedParams{
							allowedMethods: "POST",
		...
		case '/': // Prefix: "/"
				...
				case 'h': // Prefix: "hat/completions"
					...
					if len(elem) == 0 {
						...
						case "POST":
							...
							r.summary = "Create chat completion"
			...
			case 'r': // Prefix: "responses"
				...
				if len(elem) == 0 {
					...
					switch method {
					case "POST":
						r.name = CreateResponseOperation
						r.summary = "Create a model response"
						r.operationID = "createResponse"
						r.operationGroup = ""
						r.pathPattern = "/responses"
						r.args = args
						r.count = 0
						return r, true
					default:
